...
float axis_steps_per_unit[] = {2500, 2500, 3200/1.25,700}; 
...
const int X_MAX_LENGTH = 125;
const int Y_MAX_LENGTH = 125;
const int Z_MAX_LENGTH = 100;

//// MOVEMENT SETTINGS
const int NUM_AXIS = 4; // The axis order in all axis related arrays is X, Y, Z, E
float max_feedrate[] = {240, 240, 240, 500000};
float homing_feedrate[] = {200,200,120};
